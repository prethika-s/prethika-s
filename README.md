...
<p align="center">
  <strong style="color:#cfefff">Full-Stack Web Developer • Problem Solver</strong>
</p>

<p align="center">
  <a href="https://github.com/prethika-s"><img alt="GitHub followers" src="https://img.shields.io/github/followers/prethika-s?label=Follow&style=social"></a>
  &nbsp;
  <a href="https://github.com/prethika-s?tab=repositories"><img alt="Repos" src="https://img.shields.io/badge/Repos-Showcase-00ffe1"></a>
  &nbsp;
  <a href="https://www.linkedin.com/in/prethika-s"><img alt="LinkedIn" src="https://img.shields.io/badge/LinkedIn-Connect-7f5af0?logo=linkedin"></a>
</p>

---

<!-- ===== NEON GRID DIVIDER (synthwave) ===== -->
<p align="center">
  <svg width="100%" height="80" viewBox="0 0 1200 80" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="neon-divider">
    <defs>
...
## 📊 GitHub stats
<p align="center">
  <img alt="Prethika's GitHub stats" src="https://github-readme-stats.vercel.app/api?username=prethika-s&show_icons=true&count_private=true&theme=radical" />
  <img alt="Top languages" src="https://github-readme-stats.vercel.app/api/top-langs/?username=prethika-s&layout=compact&theme=radical" />
</p>

<!-- ===== NEON PAC-MAN DIVIDER (inline SVG) ===== -->
<p align="center">
  <svg width="520" height="90" viewBox="0 0 520 90" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="pacman-divider">
    <defs>
    ...
    <g stroke="none" fill="#00ffe1" filter="url(#nGlow)">
      ...
      <circle cx="260" cy="45" r="6">
        <animate attributeName="opacity" values="1;1;0" dur="2.4s" begin="0.8s" repeatCount="indefinite" />
      </circle>
      <circle cx="300" cy="45" r="6">
        <animate attributeName="opacity" values="1;1;0" dur="2.4s" begin="1.2s" repeatCount="indefinite" />
      </circle>
    </g>
...
<p align="center">
  <svg width="520" height="120" viewBox="0 0 520 120" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="ghosts">
    ...
    <g filter="url(#ghostGlow)">
      ...
      <circle cx="235" cy="45" r="6" fill="#071024"/>
    </g>
  </svg>
</p>
...
- JWT authentication and RBAC, RESTful APIs with Node.js & Express, real-time visualizations with Recharts, Excel export via ExcelJS. 

### Blogify — AI-driven Blogging App  
- Full-stack blogging platform with JWT auth, role-based dashboards, Gemini API + GraphQL integration for AI content generation, and a custom markdown editor with image upload. 

### Train Traffic and Congestion Control — SIH2025  
- Simulation / control project for Smart India Hackathon 2025. 
